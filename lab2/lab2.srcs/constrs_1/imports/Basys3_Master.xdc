...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {H[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {H[0]}]
set_property PACKAGE_PIN E19 [get_ports {H[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {H[1]}]
set_property PACKAGE_PIN U19 [get_ports {H[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {H[2]}]
set_property PACKAGE_PIN V19 [get_ports {H[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {H[3]}]
set_property PACKAGE_PIN W18 [get_ports {H[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {H[4]}]
set_property PACKAGE_PIN U15 [get_ports {H[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {H[5]}]
set_property PACKAGE_PIN U14 [get_ports {H[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {H[6]}]
set_property PACKAGE_PIN V14 [get_ports {H[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {H[7]}]
#set_property PACKAGE_PIN V13 [get_ports {H[8]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {H[8]}]
#set_property PACKAGE_PIN V3 [get_ports {H[9]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {H[9]}]
#set_property PACKAGE_PIN W3 [get_ports {H[10]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {H[10]}]
#set_property PACKAGE_PIN U3 [get_ports {H[11]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {H[11]}]
#set_property PACKAGE_PIN P3 [get_ports {H[12]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {H[12]}]
#set_property PACKAGE_PIN N3 [get_ports {H[13]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {H[13]}]
#set_property PACKAGE_PIN P1 [get_ports {H[14]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {H[14]}]
